...
<img src="images/AppVsSite_Comparison1.png" width="700" height="500"/>
...
<!-- .slide: style="text-align: left;"> -->
- **Back-End**:<br>
<font size="6">- The backend is the part of the website that is not visible to the users.<br></a></font> 
...
<!-- .slide: style="text-align: left;"> -->
1. **Full Stack Framework**:<br> 
- Full stack are one of the best Python web application frameworks, known as one-stop-solution for fulfilling all kinds of app building requirements.<br>
2. **Micro-Framework**:<br> 
- These kinds of web frameworks are known as the lightweight framework (non full stack framework).<br>
3. **Asynchronous Framework**:<br>  
- Asynchronous web frameworks are now taking over its place as a microframeworks that allows a user to handle large sets of concurrent connections.<br>
